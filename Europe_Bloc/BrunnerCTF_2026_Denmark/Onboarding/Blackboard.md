  ...
  Key mechanics of the Dancing Men cipher:
  • Each stick figure pose represents a letter of the English alphabet.
  • A figure holding a flag indicates the end of a word.
  ...
  , squatting legs → s
  4. Figure 4: Arms in a V-shape, straight legs together → h
  5. Figure 5: Arms in a V-shape, left leg extended horizontally
  ...
  9. Figure 9: Arms in a V-shape, legs in inverted V-shape → e
  10. Figure 10: Arms in a V-shape, right leg bent outward to the right → r
  11. Figure 11: Left arm raised at

      ∘
    90 

  , right arm on hip → l
  12. Figure 12: Arms in a V-shape, left leg kicking to the left → o
  13. Figure 13: Arms bent forward, squatting legs → c
